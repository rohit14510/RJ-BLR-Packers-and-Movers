...
$mail->Port     = 587;
// Sender info 
$mail->setFrom('info@srllogistics.in', 'SRL Logistics Packers and Movers'); 
$mail->addReplyTo('info@srllogistics.in', 'Test Email'); 
 
// Add a recipient 
$mail->addAddress('srllogistics32@gmail.com'); 
...
$mailContent = ' 
    ...
    <p>SRL Logistics Packers and Movers</p>';  
...
if(!$mail->send()){ ?>
    ...
    window.location.href="https://srllogistics.in/thanks.html";
    </script>
    // 
    <?php
